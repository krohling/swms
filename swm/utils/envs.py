...
def get_lang_table_env(kwargs, seed=54):
    # Lazy: language_table/tf_agents are only needed for LangTable evals;
    # keeping them module-level breaks OGBench-only environments (e.g. the
    # LARG venv, which has ogbench but not language_table).
